...
describe('ReservationService', () => {
    ...
    describe('calculatePrice', () => {
        ...
        it('пустой промокод превращается в null', async () => {
            ...
            expect(apiPost).toHaveBeenCalledWith('/reservations/calculate', expect.objectContaining({ promo_code: null }));
        });
    });
    describe('createReservation', () => {
        it('добавляет user_id в payload при наличии', async () => {
            ...
            expect(apiPost).toHaveBeenCalledWith('/reservations/', expect.objectContaining({ user_id: 7 }));
        });
