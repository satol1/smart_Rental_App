            ...
            >
                ...
                <div className="p-4 flex-1 flex flex-col">
                    ...
                    <AccessoriesSection
                        ...
                        isDisabled={(status !== 'available' && status !== 'added') || isUnderRepair}
                    ...
                    {/* Передаем обработчик из props в CardFooter */}
                    <CardFooter
                        status={status}
                        dateRange={dateRangeDisplay}
                        selected={isSelected}
                        onToggleSelection={(e) => stopPropagationAndToggle(e, onToggleSelection)}
                        isUnavailable={isUnderRepair}
