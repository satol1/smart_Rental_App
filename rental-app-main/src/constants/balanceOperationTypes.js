...
export function getOperationTypeLabel(operationType) {
    return BALANCE_OPERATION_TYPES[operationType] || operationType;
}
/**
 * Определить цвет для типа операции
 */
export function getOperationTypeColor(_operationType, amount) {
 ...
 */
export function getOperationTypeIcon(operationType) {
