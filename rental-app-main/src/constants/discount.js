...
export function combinedDiscountPercentage(durationDiscountPercentage, promoDiscountPercentage) {
    return Math.min(durationDiscountPercentage + promoDiscountPercentage, MAX_COMBINED_DISCOUNT_PERCENT);
}
