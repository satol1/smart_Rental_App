 ...
 */
export function useUnifiedDateValidation({ startDate, endDate, validateStartDate = true, validateEndDate = true }) {
    const { startDateError, endDateError, isHolidayValid, holidays } = useHolidayValidation(startDate, endDate);
