...
export function useEditReservation({ onSuccessCallback, onClearState, }) {
    ...
    return useMutation({
        ...
        onSuccess: (updatedReservation, variables) => {
            ...
            if (variables.isAdminContext) {
                ...
                queryClient.setQueriesData({ queryKey, exact: false }, (oldData) => {
                    ...
                    return {
                        ...
                        pages: oldData.pages.map(page => ({
                            ...page,
                            items: page.items.map(item => item.id === updatedReservation.id ? updatedReservation : item),
                        })),
                    };
                });
            }
                ...
                queryClient.setQueriesData({ queryKey, exact: false }, (oldData) => {
                    ...
                    if (Array.isArray(oldData)) {
                        ...
                        const items = oldData;
                        const updatedArray = items.map(item => item.id === updatedReservation.id ? updatedReservation : item);
