 ...
 */
export const useEquipmentCardViewModel = (options: EquipmentCardOptions): EquipmentCardConfig => {
    const {
        equipment,
    ...
    const handleToggleAccessory = useCallback((equipmentId: number, accessoryId: number) => {
    ...
    const checkAccessorySelected = useCallback((equipmentId: number, accessoryId: number) => {
