...
export const usePackCardViewModel = (pack: CatalogPackItem) => {
    ...
    const cheapestItem = useMemo(() => {
        if (!pack.cheapest_available_id) return null;
    ...
    return {
        ...
        buttonVariant: (isAddedToReserve ? "secondary" : "default") as "secondary" | "default"
    };
};
