...
export const useReservationFormData = () => {
    ...
    const { items, selectedAccessories, remove: removeItemFromStore, clear: clearReserveStore, isAccessorySelected, toggleAccessory } = useReserveStore();
    const { promoCodeInput, appliedPromoCode, setPromoCodeInput, applyPromoCode, removePromoCode } = usePromoCodeStore();
    return {
        // Данные пользователя
        user,
        // Данные дат
