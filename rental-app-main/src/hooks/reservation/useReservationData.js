...
export function useReservationData(reservation, state) {
    // Используем все состояния и действия из обновленного стора
    const { promoCodeInput, appliedPromoCode, setPromoCodeInput, applyPromoCode: applyPromoCodeFromStore, removePromoCode, initializeFromReservation } = usePromoCodeStore();
