...
export function useReservationActions({ reservation, state, hasConflicts, appliedPromoCode, onFullCancellation, isAdminContext, onFinishEditing, // ✨ 1. Принимаем колбэк
 }) {
