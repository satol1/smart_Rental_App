 ...
 */
export function useRentalEditForm({ rental }) {
    const form = useForm({
    ...
    const { endDateError: holidayError, isHolidayValid } = useHolidayValidation(startDateForValidation, endDateForValidation);
    return {
        form,
