...
import { handleQueryError, getApiErrorMessage, isApiErrorLike, } from '@/lib/queryHelpers';
vi.mock('sonner', () => ({
    toast: { error: vi.fn() },
}));
...
describe('getApiErrorMessage', () => {
    ...
    it('склеивает массив ошибок валидации', () => {
        ...
        expect(getApiErrorMessage(err, 'fallback')).toBe('поле email обязательно, некорректный формат');
    });
