 ...
 */
export function calculateDayCount(start, end, holidays = []) {
 ...
 */
export function formatDateRangeEuropean(start, end) {
    if (!start || !end)
        return "";
 ...
 */
export function calculateDaysOverdue(dueDate, daysOverdue) {
 ...
 */
export function transformAccessoryLinks(reservation) {
