 ...
 */
export const EQUIPMENT_UNDER_REPAIR_CONDITION = "Требует ремонта";
/**
 ...
 */
export function isEquipmentUnderRepair(equipment) {
 ...
 */
export function isEquipmentAvailableForReservation(equipment) {
 ...
 */
export function getEquipmentCardStyles(equipment, _status = "available", isSelected = false) {
 ...
 */
export function getEquipmentStatusText(equipment) {
 ...
 */
export function createAvailabilityMap(availabilityData) {
    const map = {};
