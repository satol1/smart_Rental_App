"""
Простые unit тесты для PeriodService без базы данных
"""
...
class TestPeriodServiceSimple:
    """Простые тесты для PeriodService без зависимостей от БД"""
        ...
        for period_type in ["week", "month", "quarter", "year"]:
            for offset in [-2, -1, 0, 1, 2]:
                ...
                if period_type == "week":
                    ...
                    assert days_diff == 364 or days_diff == 365  # Обычный или високосный год (включительно)
